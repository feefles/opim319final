...
to make-breeds
  ...
  create-ones   (num-turtles / 5) [ set color red ]
  create-twos   (num-turtles / 5) [ set color yellow ]
  create-threes (num-turtles / 5) [ set color green ]
  create-fours  (num-turtles / 5) [ set color blue ]
  create-fives  (num-turtles / 5) [ set color violet ]
end
  ...
  if defection-heuristic = "defection reputation" [
    let partner-defection-reputation (ask-defection-reputation define-agentset)
     ifelse partner-defection-reputation < 0 [
      ...
      set defect-now? (random-float 1 > default-prob-cooperate)
    ]
  ]
...
to-report lie-to-me? [agent]
  ...
  if lying-heuristic = "randomly" [
    report random-float 1 < default-prob-lie
  ]
